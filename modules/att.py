...
包含 CoordAtt 和 CoordCrossAtt 两种坐标注意力机制的实现。
"""
import torch
...
class CoordCrossAtt(nn.Module):
    ...
    def __init__(self, inp, oup, reduction=32, num_heads=1):
        super().__init__()
...
class BiCoordCrossAtt(nn.Module):
    ...
    """
    def __init__(self, inp, oup, reduction=32, num_heads=4):  # 建议 head 数稍微多一点
        super().__init__()
        self.num_heads = num_heads
